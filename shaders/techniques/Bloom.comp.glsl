...
const vec2 workGroupsRender = vec2(0.5 * RENDER_SCALE_FACTOR, 0.5 * RENDER_SCALE_FACTOR);
...
const vec2 workGroupsRender = vec2(0.125 * RENDER_SCALE_FACTOR, 0.125 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 4
const vec2 workGroupsRender = vec2(0.0625 * RENDER_SCALE_FACTOR, 0.0625 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 5
const vec2 workGroupsRender = vec2(0.03125 * RENDER_SCALE_FACTOR, 0.03125 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 6
const vec2 workGroupsRender = vec2(0.015625 * RENDER_SCALE_FACTOR, 0.015625 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 7
const vec2 workGroupsRender = vec2(0.0078125 * RENDER_SCALE_FACTOR, 0.0078125 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 8
const vec2 workGroupsRender = vec2(0.00390625 * RENDER_SCALE_FACTOR, 0.00390625 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 9
const vec2 workGroupsRender = vec2(0.001953125 * RENDER_SCALE_FACTOR, 0.001953125 * RENDER_SCALE_FACTOR);
#elif BLOOM_SCALE_DIV == 10
const vec2 workGroupsRender = vec2(0.0009765625 * RENDER_SCALE_FACTOR, 0.0009765625 * RENDER_SCALE_FACTOR);
#endif
